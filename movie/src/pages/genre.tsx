...
const GenrePage: React.FC = () => {
  ...
  const [genres, setGenres] = useState<Genre[]>([]); // 장르 배열
  const [selectedGenre, setSelectedGenre] = useState<number | null>(null); // 선택된 장르
  const [movies, setMovies] = useState<Movie[]>([]); // 영화 배열
