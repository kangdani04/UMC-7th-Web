...
import usePaginationMovies from "../hooks/usePaginationMovies";  // 수정된 훅
...
const MoviesPage = ({ url }) => {
  ...
  const { data, isLoading, isError, isPreviousData, fetchNextPage, fetchPreviousPage, hasNextPage } = usePaginationMovies({
    url,
    currentPage
  });
